...
(function() {
        ...
        if (!comparator) {
          ...
          return function(a, b) {
            ...
            for (key in comparator) {
              ...
              aValue = (typeof a.get === "function" ? a.get(key) : void 0) || a[key];
              bValue = (typeof b.get === "function" ? b.get(key) : void 0) || b[key];
              if (value === -1) {
  ...
  Query = (function() {
    ...
    Query.prototype.test = function(model) {
      var $beginsWith, $beginsWithValue, $endWithValue, $endsWith, $size, empty, exists, field, id, match, matchAll, matchAny, query, selector, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref;
      matchAll = true;
      matchAny = false;
      empty = true;
      _ref = this.query;
      for (field in _ref) {
        ...
        if (_.isString(selector) || _.isNumber(selector) || _.isBoolean(selector)) {
          ...
          $size = selector.$size || selector.$length;
          if ($size) {
            if ((value.length != null) && value.length === $size) {
              match = true;
            }
          }
          if (selector.$type) {
