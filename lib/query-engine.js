(function() {
  ...
  BaseCollection = Backbone.Collection.extend({
    ...
    createLiveCollection: function() {
      var collection;
      collection = new LiveCollection().setParentCollection(this);
      return collection;
    },
    find: function(query) {
      var collection;
      collection = this.createLiveCollection().setQuery('find', query).query();
      return collection;
    },
  ...
  LiveCollection = BaseCollection.extend({
    ...
    setSearchString: function(searchString) {
      ...
      _.each(pills, function(pill, pillName) {
        return cleanedSearchString = pill.setSearchString(searchString);
      });
