...
(function() {
  ...
  QueryCollection = (function(_super) {
    ...
    QueryCollection.prototype.findOne = function(query, comparator, paging) {
      ...
      models = this.createChildCollection([], criteria).query().models;
      if ((models != null ? models.length : void 0) !== 0) {
        return models[0];
      } else {
        return null;
      }
    ...
    QueryCollection.prototype.applyCriteria = function(options) {
      var _base, _ref;
      if (options == null) {
        options = {};
      }
    ...
    QueryCollection.prototype.test = function(model, criteria) {
      var passed;
      if (criteria == null) {
        criteria = {};
      }
    ...
    QueryCollection.prototype.testFilters = function(model, filters) {
      var cleanedSearchString, passed;
      passed = true;
    ...
    QueryCollection.prototype.testQueries = function(model, queries) {
      var passed;
      passed = true;
      if (queries == null) {
    ...
    QueryCollection.prototype.testPills = function(model, pills) {
      var passed, searchString;
      passed = true;
