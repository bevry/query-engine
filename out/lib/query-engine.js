...
(function() {
  ...
  QueryCollection = (function(_super) {
    ...
    QueryCollection.prototype.initialize = function(models, options) {
      ...
      Criteria.prototype.applyOptions.call(this, options);
  ...
  Criteria = (function() {
    ...
    Criteria.prototype.options = null;

    function Criteria(options) {
      this.applyOptions = __bind(this.applyOptions, this);
      this.applyOptions(options);
    }

    Criteria.prototype.applyOptions = function(options) {
      var _base, _ref;
      if (options == null) {
        options = {};
      }
    ...
    Criteria.prototype.test = function(model) {
      var passed;
      passed = this.testFilters(model) && this.testQueries(model) && this.testPills(model);
      return passed;
    };

    Criteria.prototype.testModels = function(models) {
      var model, passed, _i, _len;
      passed = [];
      for (_i = 0, _len = models.length; _i < _len; _i++) {
        model = models[_i];
        if (this.test(model)) {
    ...
    Criteria.prototype.testCollection = function(collection) {
      var model, passed, _i, _len, _ref;
      passed = [];
    ...
    Criteria.prototype.testFilters = function(model) {
      var cleanedSearchString, filters, passed;
      passed = true;
    ...
    Criteria.prototype.testQueries = function(model) {
      var passed, queries;
      passed = true;
    ...
    Criteria.prototype.testPills = function(model) {
      var passed, pills, searchString;
      passed = true;
